...
interface TabContent {
  ...
  export const tabs: TabContent[] = [
    ...
    },
    {
      key: "source",
      title: "Provenance",
      content: `<p>This dataset is hosted by OpenSecrets in the form of a <Code color="secondary"><a href=https://docs.google.com/spreadsheets/d/1XbkS5EYb-KTkHwy4GK2-sdp84Mt1uZJkAKltoAq-Mxk/edit?gid=649570569#gid=649570569>Google Sheet</a></Code>. 
    ...
    },
    {
      key: "usage",
      title: "Usage Tips",
      content: `<p>Click on the left hand panel to filter ranges of dates which will apply to all charts.</p>
