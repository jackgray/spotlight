      ...
      <section className="flex flex-col items-center justify-center gap-4 py-8 md:py-10">
        <div className="inline-block max-w-lg text-center justify-center">
          <h2 className={subtitle({ class: "mt-4" })}>
            ...
            When no one is watching, people have a tendency to behave more selfishly. When activities are transparent, and people can put a name and face to an event, there is better incentive to act in the interests of the people.
          </h2>
          <h2 className={subtitle({ class: "mt-4" })}>
