...
async def main(start_date: Required[str], end_date: Required[str]):
...
async def transform_data(data: pd.DataFrame, url: Required[str]) -> None:
    ''' Takes in raw response from concurrent fetch processor and inserts cleaned dataframes into table '''
...
def generate_slices(total_pages: Required[int]) -> Dict:
    """
