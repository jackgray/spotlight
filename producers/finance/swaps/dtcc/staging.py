...
from config import ch_settings, dtcc_staging_schema
...
# Make third table with ICE field names matching DTCC schema (similar field names, only DTCC adds "_Leg-n") -- after column names are unified datasets can be merged
...
# ch_typecast(og_table='Swaps_DTCC_source3', new_table='Swaps_DTCC_staging2', ch_settings=ch_settings, schema=dtcc_staging_schema)
