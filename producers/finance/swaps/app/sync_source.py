...
download_batch(start_date='20240123', end_date='today', ice_schema=ice_source_schema, dtcc_schema=dtcc_source_schema, dtcc_schema2=dtcc_source_schema2, ch_settings=ch_settings)
